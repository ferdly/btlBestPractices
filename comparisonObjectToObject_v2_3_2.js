...
// ! ↪ [YES here] TEST_COLLECTION_INSTANTIATE_GOLD_PARAM_OBJECT [@ToDo: overrideObjectAObjectB]
// ! ↪ [YES here] TEST_COLLECTION_OVERRIDE_WITH_GOLD_PARAM_OBJECT [instantiate]
// ø ↪ no longer call in this block, step below
// ø TEST_COLLECTION_displayPrePstWix_FUNCT
// ø TEST_COLLECTION_WIX_WIX_MAIN => comparisonWixToWixRecords()
// ! ↪ [NO not here] TEST_COLLECTION_INSTANTIATE_GOLD_PARAM_OBJECT [@ToDo: overrideObjectAObjectB]
// ! ↪ [NO not here] TEST_COLLECTION_OVERRIDE_WITH_GOLD_PARAM_OBJECT [instantiate]
// ø ---
...
if (doCall_displayPrePstWix) {
    ...
    paramObjectLocal.displayParamObject.title = 'Pre-Post Wix Title'
    paramObjectLocal.displayParamObject.subTitle = 'Pre-Post Wix Sub-Title'
    ...
    console.warn(`≈150≈ paramObject: AFTER: 'overrideWithGoldDefaults(paramObjectLocal)' [check Title & Sub-Title]`)
    console.dir(paramObject)
    // console.warn(`Force return`)
    // return
    // console.warn(`paramObject.displayParamObject`)
    // console.dir(paramObject.displayParamObject)
...
async function displayPrePstWix(preWixRecord = {}, pstWixRecord = {}, paramObject = {}) {
    ...
    await testCollectionReportComposePaddedString(response.testCollection, paramObject.displayParamObject)
...
// ø TEST_COLLECTION_INSTANTIATE_GOLD_PARAM_OBJECT [instantiate.. @ToDo: overrideObjectAObjectB]
function instantiateGoldParamObject(paramObject = {}){
    ...
    paramObject.contentParamObject.testKind = 'ADJUST'
    paramObject.contentParamObject.supportedAssertionArray = supportedAssertionArray
    paramObject.displayParamObject.columnHeaderRow = `Attribute|PREV|CURR|Exception`
    paramObject.displayParamObject.supportedAssertionArray = supportedAssertionArray
    paramObject.displayParamObject.supportedCardinalityTypeArray = supportedCardinalityTypeArray
    paramObject.displayParamObject.defaultCardinalityTypeArray = '123'
    paramObject.displayParamObject.supportedCardinalityPunctArray = supportedCardinalityPunctArray
...
function comparisonWixToWixRecords(wixRecordA = {}, wixRecordB = {}, paramObject = {}) {
    ...
    // console.warn(`≈452≈X≈ testCollection: [array of objects below]`)
    // console.dir(testCollection)
    // ø <Assertion: HEADER>
    // let assertion = 'ASSERTION_KEY'
    // assertion = 'HEADER'
...
async function testCollectionReportPaddingPrep(testCollection = [], displayParamObject = {}) {
            ...
            for (let indexUnit = 0; indexUnit < testCollection.length; indexUnit++) {
                ...
                // // ø TEST_COLLECTION_REPORT_STRING_DISPLAY ≈X≈ ¡CALL!
                // displayParamObject.columnMaxLengthArray = []
                // await composeReportStringDisplay(element)
                // maxColCount = maxColCount > element.reportStringColCount ? maxColCount : element.reportStringColCount
                // displayParamObject.maxColCount = maxColCount
...
function composeReportStringDisplay(element = {}){
    // console.warn(`≈965≈§≈ paramObject: [object below]`)
    // console.dir(paramObject)
    // console.warn(`≈967≈§≈ paramObject.displayParamObject.columnMaxLengthArray: [array below]`)
...
if(KLUDGE){
    ...
    paramObject
    paramObject.contentParamObject = {}
    paramObject.contentParamObject.testKind = 'KLUDGE'
    // // paramObject.contentParamObject.testKind = 'ENROLL'
    paramObject.contentParamObject.incrementValue = 77
    paramObject.displayParamObject = {}
    paramObject.displayParamObject.title = 'KLUDGE Title'
    paramObject.displayParamObject.subTitle = 'KLUDGE Sub-Title'
    paramObject.displayParamObject.location = 'KLUDGE Chester Bowl'
    // paramObject.displayParamObject.passFalseString = 'zFALSE_STRINGz'
    paramObject.unitParamObject = {}
    paramObject.unitParamObject.which = 'KLUDGE'
    instantiateGoldParamObjectWithOverrideKLUDGE(paramObject)
    // paramObject = instantiateGoldParamObjectWithOverrideKLUDGE(paramObject)
    
    }
// ø </KLUDGE paramObject>
// ø --
// ø ========== </KLUDGE_AREA> ==========
async function instantiateGoldParamObjectWithOverrideKLUDGE(paramObjectLocal = {}){
    // let paramObjectDefault = {}
    // instantiateGoldParamObject(paramObjectDefault)
    console.warn(`paramObjectLocal: [caller supplied]`)
    console.dir(paramObjectLocal)
    let paramObject = await overrideWithGoldDefaults(paramObjectLocal)
    console.warn(`paramObject: [¡overridden!]`)
    console.dir(paramObject)
    // console.warn(`paramObjectDefault: [gold]`)
    // console.dir(paramObjectDefault)
    // overrideObectA_with_existingObjectB(objectA = {}, objectB = {}, utilityParamObject = {})
    // let utilityParamObject = await overrideObectA_with_existingObjectB(paramObject, paramObjectDefault)
    // let utilityParamObject = await overrideObectA_with_existingObjectB(paramObjectDefault, paramObject)
    // console.warn(`utilityParamObject: [notes]`)
    // console.dir(utilityParamObject)
    console.warn(`paramObject: ObjectA [FINAL]`)
    console.dir(paramObject)
    // console.warn(`paramObjectDefault: ObjectB [FINAL]`)
    // console.dir(paramObjectDefault)
    // return paramObjectFinal
}
async function ZinstantiateGoldParamObjectWithOverrideKLUDGE(paramObject = {}){
    let paramObjectDefault = {}
    instantiateGoldParamObject(paramObjectDefault)
    console.warn(`paramObject: [caller supplied]`)
    console.dir(paramObject)
    // console.warn(`paramObjectDefault: [gold]`)
    // console.dir(paramObjectDefault)
    // overrideObectA_with_existingObjectB(objectA = {}, objectB = {}, utilityParamObject = {})
