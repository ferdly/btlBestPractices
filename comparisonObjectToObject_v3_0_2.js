...
async function testCollectionReportDisplay(testCollection = [], displayParamObject = {}) {
    ...
    subHeaderBlock = subHeaderBlock.length ? subHeaderBlockHeader + '\n' + subHeaderBlock + '\n' : ''
...
function centerRow(string = 'STRING', rowLength = 0){
...
export function wrapRowToArray(string = 'STRING', rowLength = 0, collapsePunctArray = []){
